      ...
      <div className="flex-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-white mb-2">{t('products')}</h1>
              <p className="text-gray-400">{t('totalProducts')}: {filteredProducts.length}</p>
            </div>
            <button
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-700">
                  <tr>
                    <th className="px-6 py-4 text-left text-white font-semibold">{t('images')}</th>
                    <th className="px-6 py-4 text-left text-white font-semibold">{t('productName')}</th>
                    <th className="px-6 py-4 text-left text-white font-semibold">{t('category')}</th>
                    <th className="px-6 py-4 text-left text-white font-semibold">{t('price')}</th>
                    <th className="px-6 py-4 text-left text-white font-semibold">{t('condition')}</th>
                    <th className="px-6 py-4 text-left text-white font-semibold">{t('stock')}</th>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span className="px-3 py-1 bg-gray-600 text-white rounded-full text-sm">
                          {product.category === 'normal' ? t('normalBike') :
                           product.category === 'electric' ? t('electricBike') : t('sportBike')}
                        </span>
                      </td>
                      ...
                      <td className="px-6 py-4">
                        <span className={`px-3 py-1 rounded-full text-sm ${
                          ...
                          {product.condition === 'new' ? t('conditionNew') :
                           product.condition === 'like-new' ? t('conditionLikeNew') : t('conditionUsed')}
                        </span>
                      </td>
                      <td className="px-6 py-4">
